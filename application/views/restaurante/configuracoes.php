...
<!-- 
                    ...
                    <form method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="grid grid-cols-2 flex">
                            <div class="col-span-2 md:col-span-1 pr-0 md:pr-2.5 lg:pr-5">
                                ...
                                <input type="text"  required name="restaurante_nome" value="<?=$restaurante['restaurante_nome']?>" maxlength="200"  class="w-full h-12 p-2 mb-5 border border-black focus:outline-none">
                            </div> 
                            ...
                            <div class="col-span-2 md:col-span-1 pl-0 md:pl-2.5 lg:pl-5">
                                ...
                                <input type="file" name="restaurante_imagem" accept="image/png"   class="w-full h-12 p-2 mb-5 border border-black focus:outline-none">
                            </div>
                        </div>
                        <br><br>
                        <div class="grid grid-cols-2 flex">
                            <div class="col-span-2 lg:col-span-1 md:pl-0 ">
                                ...
                                <input type="tel" value="<?=$restaurante['restaurante_telefone']?>" name="restaurante_telefone" required  data-mask="(00) 0 0000-0000" minlength="16"  maxlength="16" autocomplete="off" class="w-full h-12 p-2 mb-5 border border-black focus:outline-none">
                            </div>
                            ...
                            <div class="col-span-2 lg:col-span-1 md:pl-0 lg:pl-5">
                                ...
                                <input type="text" name="restaurante_endereco" value="<?=$restaurante['restaurante_endereco']?>" required  maxlength="200" class="w-full h-12 p-2 mb-5 border border-black focus:outline-none">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 flex mt-3">
                            <div class="col-span-2 md:col-span-1 pr-0 md:pr-2.5 lg:pr-5">
                               ...
                               <?php foreach ($estados as $e) {  ?>
                                    ...
                                    <?php if ($e->Uf == $restaurante['restaurante_estado']) {  ?>
                                        <option selected value="<?=$e->Uf?>"><?=$e->Nome?></option>
                                    <?php }  else { ?>  
                            ...
                            <div class="col-span-2 md:col-span-1 pr-0 md:pr-2.5 lg:pr-5 lg:pl-5  pt-3 xl:pt-0">
                                ...
                                <select name="restaurante_cidade" required id="cidades" class="w-full h-12 pl-2" >
                                    ...
                                    <option selected class="uppercase" value="<?=$restaurante['restaurante_cidade']?>"><?=$restaurante['restaurante_cidade']?></option>
                        ...
                        <div class="grid grid-cols-2 flex mt-3">
                            <div class="col-span-2 md:col-span-1 pr-0 md:pr-2.5 lg:pr-5">
                                ...
                                <select name="restaurante_categoria" required class="w-full h-12 pl-2 uppercase" >
                                    ...
                                    <?php foreach ($categorias as $c) {  ?>
                                        ...
                                        <?php if ($c->id == $restaurante['restaurante_categoria']) {  ?>
                                            <option selected class="uppercase" value="<?=$c->id?>"><?=$c->cat_nome?></option>
                                        <?php }  else { ?>  
                            ...
                            <div class="col-span-2 md:col-span-1 pl-0 md:pl-2.5 lg:pl-5">
                                ...
                                <input type="number" value="<?=$restaurante['restaurante_preparo_medio']?>" name="restaurante_preparo_medio" data-mask="00" required minlength="1"  maxlength="2" class="w-full h-12 p-2 mb-5 border border-black focus:outline-none">
                            </div>
                        </div>
                    ...
                    <div class="grid justify-center md:justify-center">
                        <button type="submit" class="w-auto h-12 px-20 mb-5 mt-14 xl:mt-10  bg-green" >
                            <p class="font-semibold uppercase text-white text-xl">SALVAR</p>
                        </button>
                    </div>
                    </form>
