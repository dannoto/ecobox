        ...
        <main class="pt-16">
            <div class="grid grid-cols-1 py-5 md:py-14 px-5 md:px-14 lg:px-24 xl:px-32"> 
                <div class="col-span-1 bg-white px-5 py-5 md:px-8 lg:px-14 md:py-8 lg:py-10 h-auto">
                    <h1 class="font-semibold text-xl md:text-xl text-center md:text-left pb-10">Informações de Segurança</h1>

                    <h2 class="font-semibold text-lg  pb-5">Alterar Senha</h2>

                    <form action="" method="POST">
                        <div class="grid grid-cols-2 flex">
                            <div class="col-span-2 md:col-span-1 md:col-span-1">
                                <label for="senhaAtual" class="font-semibold uppercase text-sn">Senha Atual</label>
                                <input type="password" name="user_current_password" required minlength="6" maxlength="200" id="password" class="w-full h-12 p-2 mb-5 border border-black  focus:outline-none">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 flex">
                            <div class="col-span-2 md:col-span-1 md:col-span-1">
                                ...
                                <input type="password" name="user_new_password" required minlength="6" maxlength="200" id="password" class="w-full h-12 p-2 mb-5 border border-black  focus:outline-none">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 flex">
                            <div class="col-span-2 md:col-span-1 md:col-span-1">
                                ...
                                <input type="password" name="user_confirm_password" required minlength="6" maxlength="200" id="password" class="w-full h-12 p-2 mb-5 border border-black  focus:outline-none">
                            </div>
                        </div>
                        <div class="grid justify-center md:justify-start">
                        
                            <?php if ($this->session->flashdata('response')) { ?>
                                <p class="text-red-500 font-semibold text-center"><?=$this->session->flashdata('response')?></p>
