...
<body >
    <section>
        ...
        <main class="pt-16">
            <p class="text-xl  xl:ml-12 ml-5 mt-12">Resultados para <span class="text-green font-semibold"><?=$categoria_nome?></span> em <span class="text-green font-semibold" ><?=$cidade?></span></p>
  ...
  <br>
            <div class=" ml-5 xl:ml-12 mr-5 xl:mr-12 " >
                <div class="bg-green h-32 rounded-md flex justify-center p-3 items-center">
                    <br>
        ...
        <!-- Início Restaurantes-->
            <div class="grid grid-cols-12 lg:grid-cols-10 xl:px-0 px-5 md:px-0">
                ...
                <div class="col-span-12 md:col-span-10 lg:col-span-8 pb-10">
                    <div class="grid grid-cols-2 xl:ml-12 md:grid-cols-6 xl:grid-cols-8 gap-5">
                                            ...
                                            <div class="bg-white w-11/12 mt-20 lg:w-4/6 xl:w-2/2 ">
                                                ...
                                                <!-- <form action="" id="form-add-produto"> -->
                                                    <div class=" grid xl:grid-cols-2 grid-cols-1" >
                                                        ...
                                                        <div class="xl:span-col-1 span-col-1 w-full xl:pt-0 pt-3 xl:pl-0 pl-5 pr-5 ">
                                                            <div class="flex">
