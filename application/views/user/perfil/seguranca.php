                    ...
                    <form action="">
                        <div class="grid grid-cols-2 flex">
                            <div class="col-span-2 md:col-span-1 md:col-span-1">
                                ...
                                <input type="password" name="user_password" minlength="6" maxlength="200" id="password" class="w-full h-12 p-2 mb-5 border-2 border-opacity-50 border-gray-700 rounded-md focus:outline-none">
                            </div>
                        </div>
