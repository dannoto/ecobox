...
<!-- 
    ...
    <div class="col-span-3  grid justify-items-center">
                <p class="font-semibold text-grey md:pt-12 pt-12 md:text-4xl text-xl ">Crie uma Conta</p>
                ...
                <form action="" class="md:grid grid-cols-1 md:p-48 md:pt-12  p-12 w-full  ">
                    ...
                    <label for="email" class="font-semibold" >E-mail</label>
                    <input type="email" name="email" id="email" class="w-full col-span-1 h-12 p-4 border-2 border-opacity-25 border-gray-700  rounded-md mb-5"  required maxlength="200" id="email" >
                    
                    <label for="telefone" class="font-semibold" >Telefone</label>
                    <input type="text" name="telefone" id="telefone" class="w-full col-span-1 h-12 p-4 border-2 border-opacity-25 border-gray-700  rounded-md mb-5"  required maxlength="200" id="email" >
                    ...
                    <div class="flex">
                        <div class="flex-auto mr-1">
                            <input class="border-2 border-green" type="checkbox" >
                        </div>
                        <div class="flex-auto">
                            <p class="md:text-base ml-4 text-sm">Ao continuar você concorda com o <a href="<?=base_url()?>termos" class="font-semibold nodecoration">Termos e Condições</a></p>
                        </div>
                    </div>

                    <button type="submit" class="mt-5 h-12 rounded-md w-full  bg-green " >
                        <p class="font-semibold text-white md:text-xl text-lg">CRIAR CONTA</p>
                    </button>
                </form>
