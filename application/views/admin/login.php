            ...
            <div class="cold-span-1 h-screen">
                <div class="grid justify-items-center items-center h-screen p-5 md:px-8 lg:px-14 lg:py-8 xl:px-28 xl:py-12">
                    <div>
                        ...
                        <!-- Início Título -->
                        <p class="font-semibold text-gray-700 text-2xl md:text-3xl text-center px-5 py-5 md:py-6 xl:pb-8">Painel Administrativo</p>
                        <!-- Fim Título -->
                        ...
                        <form  method="POST" class="">
                            ...
                            <input type="email" name="admin_email" maxlength="200" id="email" class="w-full h-12 p-2 mb-5 border-2 border-opacity-50 border-gray-700 rounded-md focus:outline-none" required maxlength="200">

                            <label for="password" class="font-semibold text-gray-700">Senha</label>
                            <input type="password" name="admin_password" minlength="6" maxlength="200" id="password" class="w-full h-12 p-2 mb-5 border-2 border-opacity-50 border-gray-700 rounded-md focus:outline-none" required maxlength="200">
