            ...
            <div class="grid xl:grid-cols-1 py-5 md:py-14 px-5 md:px-14 lg:px-24 xl:px-32"> 
                    ...
                    <div class="w-full grid xl:grid-cols-2 grid-cols-1 xl:mb-0 mb-5"> 
                        ...
                        <div class="xl:col-span-1 grid-cols-2">
                            <h1  class="font-semibold text-left text-xl md:text-2xl   text-gray-700 ">Termos</h1>
                            <p class="pb-8 text-left">Seus termos de uso do Ecobox.</p>
                        </div>
                    ...
                    <div class="w-full">
                        ...
                        <form action="" method="POST">
                            ...
                            <input type="text" name="termos_titulo" value="<?=$termos['termos_nome']?>" class="h-12 p-2 border border-gray-200 xl:w-2/3 w-full" >
                            <br><br>
                            <label for="">CONTEÚDO</label><br>
                            <textarea name="termos_conteudo"  class="p-2 h-96 border border-gray-200 xl:w-2/3 w-full" ><?=$termos['termos_conteudo']?></textarea>
