            ...
            <div class="grid xl:grid-cols-1 py-5 md:py-14 px-5 md:px-14 lg:px-24 xl:px-32"> 
                    ...
                    <div class="w-full grid xl:grid-cols-2 grid-cols-1 xl:mb-0 mb-5"> 
                        ...
                        <div class="xl:col-span-1 grid-cols-2">
                            <h1  class="font-semibold text-left text-xl md:text-2xl   text-gray-700 ">Meus Usuários</h1>
                            <p class="pb-8 text-left">Seus usuários no ecobox.</p>
                        </div>
                    ...
                    <?php if (count($usuarios) > 0 ) { ?>
                        ...
                        <div class="border-gray-400 flex border mt-2 xl:w-2/3  ">
                            <div>
                                <img class="w-32 h-32" src="<?=base_url()?>assets/images/avatars/<?=$v->user_imagem?>" alt="">
                            </div>
                            <div>
                                <h1 class="p-3 font-semibold"><?=$v->user_nome?> <?=$v->user_sobrenome?></h1>

                                <p class="pl-3"><?=$v->user_email?></p>
                                <p class="pl-3"><?=$v->user_telefone?></p>
