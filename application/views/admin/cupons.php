        ...
        <main class="pt-16 bg-white">
            ...
            <div class="grid xl:grid-cols-1 py-5 md:py-14 px-5 md:px-14 lg:px-24 xl:px-32"> 
                    ...
                    <?php if (count($cupons) > 0 ) { ?>
                        <?php foreach ($cupons as $v ) { ?>
                            
                            <div class="grid xl:grid-cols-5  grid-cols-1 w-full border border-gray-100 mt-2">
                                <div class="span-col-1">
                                 <img class="xl:w-32 h-32 w-full" style="object-fit: cover;" src="<?=base_url()?>assets/images/cupom.png" alt="">
                                </div>
                                <div class="span-col-3 ">
                                    <p class="mt-2 font-semibold uppercase"><?=$v->cupom_codigo?></p>
                                    <p class="mt-2 text-sm uppercase">DESCONTO </p>
                                    <span><?=$v->cupom_desconto?>%</span>
                                    <p class="mt-2 text-sm  uppercase">COMPRA MÍNIMA</p>
                                    <span> R$ <?=$v->cupom_minimo?></span>
                                </div>
                                <div class="span-col-1 ">
                                    <div onclick="deleteCupom(<?=$v->id?>)" class="bg-red-500 w-full flex justify-center items-center cursor-pointer xl:w-8 h-full">
               ...
               <?php } else { ?>
                    ...
                    <div class="   mt-5" >
                        <div class="bg-green h-32 rounded-md flex justify-center items-center">
                            <p class="text-center text-white ">Nenhum cupom encontrado.</p>
                        </div>
                    </div>
                                ...
                                <div class="bg-white mt-12 xl:mt-5 w-11/12 lg:w-4/6 xl:w-1/3 ">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <form action="" id="form" enctype="multipart/form-data" method="POST">
                                            <input type="hidden" name="add_cupom" value="1">
                                            <label for="">Código do Cupom</label><br>
                                            <input class="h-12 p-2  border border-gray-300 w-full" maxlength="100" type="text" name="cupom_codigo" required>
                                                <br><br>
                                            <label  for="">Desconto (%)</label><br>
                                            <input  class="h-12 p-2 border border-gray-300  w-full" type="number" max="100" min="1"  name="cupom_desconto" required >

                                            <label  for="">Valor Mínimo da Compra</label><br>
                                            <input  class="h-12 p-2 border border-gray-300   w-full" type="text"   name="cupom_minimo" id="cupom_minimo" required >
